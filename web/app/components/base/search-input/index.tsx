...
const SearchInput: FC<SearchInputProps> = ({
  ...
  return (
    <div className={cn(
      'group flex items-center px-2 h-8 rounded-lg bg-gray-200 hover:bg-gray-300 border border-transparent overflow-hidden dark:bg-[#2F3335]',
      ...
      <input
        ...
        name="query"
        className={cn(
          'grow block h-[18px] bg-gray-200 rounded-md border-0 text-gray-700 text-[13px] placeholder:text-gray-500 appearance-none outline-none group-hover:bg-gray-300 caret-blue-600 dark:bg-[#2F3335]',
